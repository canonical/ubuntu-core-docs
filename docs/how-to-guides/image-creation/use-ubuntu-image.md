...
These additional snaps can include {ref}`custom snaps <how-to-guides-image-creation-add-custom-snaps>`, locally-stored {ref}`offline snaps <ref-remodelling_offline-remodelling>`, and snaps that can be downloaded directly from the store.
