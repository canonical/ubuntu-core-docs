...
If you want to include your own core snaps, such as a custom gadget snap, see [Build an image with custom snaps](add-custom-snaps) for details on how the model assertion and _ubuntu-image_ command need to be modified.
