...
Ubuntu Core supports a set of system-wide options that allow you to customize your snap and core environment. See [System options](https://snapcraft.io/docs/system-options) for which options are supported.
